		...
		<div class="row content">
			<div class="col-sm-8 col-sm-offset-2"> 
				...
				<center>
					...
					<a href="https://offthegrid.000webhostapp.com/hdoc/resourcesinput.php" class="btn btn-info btn-lg" role="button" style="margin-bottom:5%">Resources Information</a><br >
