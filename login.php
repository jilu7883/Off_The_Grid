...
?>
					...
					<li class="active"><a href="http://offthegrid.000webhostapp.com/hdoc/login.php">Login</a></li>
					<li><a href="http://offthegrid.000webhostapp.com/hdoc/signup.php">Sign Up</a></li>
				</ul>
			</div>
		</div>
	</nav>
	...
	<div class="container-fluid"> 
		<div class="row content">
			...
			<center>
				<a href="http://offthegrid.000webhostapp.com/hdoc/signup.php"><button type="button" class="btn btn-link">Don't have an account yet, Click Here!</button></a>
			</center>
		</div>
