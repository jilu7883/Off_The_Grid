				...
				<script>
					function activateButton(element) {
						if(element.checked) {
							...
							document.getElementById("resunit").innerHTML = "<a href='http://offthegrid.000webhostapp.com/hdoc/loginresc.php' class='btn btn-info btn-lg' role='button' style='margin-bottom:2%'>Rescue Unit</a><br>";
