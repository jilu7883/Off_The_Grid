			...
			<div class="col-sm-8 col-sm-offset-2"> 
				...
				<div class="col-sm-12" style="margin-bottom:10%"> 
					...
					<center>
						...
						<li><a href="http://offthegrid.000webhostapp.com/hdoc/resourcesinput.php" class="btn btn-info btn-lg" role="button" style="margin-top:3%; margin-bottom:5%">Resources Information</a><br >
						<li><a href="http://offthegrid.000webhostapp.com/hdoc/map.php" class="btn btn-info btn-lg" role="button" style="margin-bottom:5%">Map</a><br >
						<li><a href="http://offthegrid.000webhostapp.com/hdoc/chat.php" class="btn btn-info btn-lg" role="button">Chat</a>
					</center>
				</div>
			</div>
		</div>
