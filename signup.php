...
?>
					...
					<li><a href="http://offthegrid.000webhostapp.com/hdoc/login.php">Login</a></li>
					<li class="active"><a href="http://offthegrid.000webhostapp.com/hdoc/signup.php">Sign Up</a></li>
				</ul>
			</div>
		</div>
	</nav>
	...
	<div class="container-fluid">
		<div class="row content" style="margin-bottom:15%">
			...
			<center>
				<a href="http://offthegrid.000webhostapp.com/hdoc/login.php"><button type="button" class="btn btn-link">Alredy have an account, Click Here!</button></a>
			</center>
		</div>
